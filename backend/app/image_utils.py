"""Utilities for image identifiers and HuggingFace URLs."""
...
def sanitize_image_id(image_id: str) -> str:
    """Validate and sanitize a ROCOv2 image identifier."""
...
def image_folder_name(image_id: str) -> str:
    """Determine the HuggingFace subfolder containing a ROCOv2 image."""
...
def hf_image_url(image_id: str) -> str:
    """Build the public HuggingFace URL for a ROCOv2 dataset image."""
    safe_id = sanitize_image_id(image_id)
...
def with_public_result_paths(payload: Mapping[str, Any]) -> dict[str, Any]:
    """Copy a response payload while replacing local paths with HuggingFace URLs."""
